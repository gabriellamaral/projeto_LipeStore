...
<form name="at_cliente" action="<?= $BASE_URL ?>../config/processo_cliente.php" method="POST">
    ...
    <input type="hidden" name="codcliente" value="<?= $_SESSION['codigo_do_cliente'] ?>">
    ...
    <fieldset>
        <div style="padding-left: 320px;">
            ...
            <p>
                ...
                <input required type="text" name="telefone" id="telefone" value="<?= $cliente["telefone"] ?>" size="30"
                    maxlength="11">
            ...
            <p>
                ...
                <input required type="email" name="email" id="email" value="<?= $cliente["email"] ?>" size="72" />
            </p>
            ...
            <p>
                ...
                <input required type="text" name="cidade" id="cidade" value="<?= $cliente["cidade"] ?>" size="27"
                    maxlength="25" />
            </p>
            <p>
                <label for="bairro">Bairro:</label>
                <input required type="text" name="bairro" id="bairro" value="<?= $cliente["bairro"] ?>" size="25"
                    maxlength="25" />
            ...
            <p>
                ...
                <input required type="text" name="usuario" id="usuario" value="<?= $cliente["usuario"] ?>" size="28.5"
                    maxlength="50" />

                <label class="espaca-esquerda" for="senha">Senha:</label>
                <input required type="password" name="senha" id="senha" value="<?= $cliente["senha"] ?>" size="28.5"
                    maxlength="50" />
            </p>
        </div>
        <br>
